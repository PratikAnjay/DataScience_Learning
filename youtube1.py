...
def main():
  ...
  #try: 
    ...
    if (choose_model=='Python for Data Science'):
            logo=Image.open("p8.jpg")
            logo1=Image.open("p9.jpg")
